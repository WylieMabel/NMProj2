...
be important and what is generally happening in the network.

![Wave 1](task4/plots/Net1.png){width="314"}

![Wave 2](task4/plots/Net2.png){width="267"}

![Wave 3](task4/plots/Net3.png){width="267"}
...
```{r, echo=FALSE}
siena.table(model4, type = "html", sig = TRUE)
```

![](task4/model3.png){width="181"}
...
![](task4/plots/gof/model3/alcohol_behaviour.png){width="204"}

![](images/clipboard-1245071439.png){width="237"}

![](task4/plots/gof/model3/outdegree_distribution.png){width="243"}

![](task4/plots/gof/model3/triad_census.png){width="295"}

![](task4/plots/gof/model3/geodist_distribution.png){width="303"}
